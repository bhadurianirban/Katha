package org.bhaduri.ksaman.edit.anubad;
 ...
 * @author dgrfiv
 */
@Named(value = "addEditAnubad")
@ViewScoped
public class AddEditAnubad implements Serializable {
...
//        }
        ...
        if (responseCode == HedwigResponseCode.SUCCESS) {
            fm = new FacesMessage(FacesMessage.SEVERITY_INFO, "Success", "Shloka Anubad updated Successfully.");
