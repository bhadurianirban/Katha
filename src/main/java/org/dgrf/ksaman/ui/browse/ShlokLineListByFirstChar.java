 ...
 * @author dgrfiv
 */
@Named(value = "shlokLineListByFirstChar")
@ViewScoped
public class ShlokLineListByFirstChar implements Serializable {
    ...
    public void loadAllShlokaList() {
        ...
        shlokaDTOList = new ShlokLineListByFisrstCharLDM(firstChar);
...
//        }
    ...
    public String moveToFullShlokView() {
